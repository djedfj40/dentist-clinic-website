...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
	  ...
	  $filenameaddquery = htmlspecialchars( basename( $_FILES["fileToUpload"]["name"]));
	  
	  $completepath = $target_dir.$filenameaddquery;
	  
	  $addimagequery = "INSERT INTO clinicphoto (id,filename,path) VALUES ('','$filenameaddquery','$completepath')";

$addimage = mysqli_query($conn, $addimagequery);
