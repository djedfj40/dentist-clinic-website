...
$cleansedpage_id= mysqli_real_escape_string($conn,$page_id);
		  ...
		  $staffquery = "SELECT * FROM staffinfo WHERE id='$cleansedpage_id'";

$staff = mysqli_query($conn, $staffquery);
		  
 $staffinforow = mysqli_fetch_array($staff);
...
<head>
  ...
  <title>EXPERT STAFF, Prof. Dr. Sinan TOZOĞLU | ProDentalia Dental Clinic | Antalya, Turkey | www.prodentalya.com </title>
...
<body>
  ...
  <div class="sayfabaslik dar">
    <h3><?php echo $staffinforow ['name'];?></h3> 
  </div>

  <div class="icerikalani">
    <div class="icerik"> 
      
      <h1><?php echo $staffinforow ['name'];?></h1>
      
      <img class="portre" src="<?php echo $staffinforow ['photopath'];?>">
      
      <p><?php echo $staffinforow ['description'];?></p>
  ...
  <footer>
    ...
    <p class="imza">All rights reserved for<br>Dental Clinic<br><br>©2020<br><br></p>
